...
- [ ] (+Geometry) [Non-decreasing Array](https://leetcode.com/problems/non-decreasing-array/)
- [ ] (+Math) [Find Palindrome With Fixed Length](https://leetcode.com/problems/find-palindrome-with-fixed-length/)
